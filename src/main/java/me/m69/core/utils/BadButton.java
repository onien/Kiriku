...
public class BadButton {
    ...
    public BadButton(ItemStack itemStack) {
     ...
     */
    public BadButton(ItemStack itemStack, Consumer<InventoryClickEvent> action) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BadButton)) {
            return false;
        }
        BadButton button = (BadButton) o;
        return ID == button.ID;
    }
