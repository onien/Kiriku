...
public class License {
    ...
    public boolean register(){
        log(0, Messages.CC("&eChecking your license"));
        log(0, Messages.CC("§7-------------------------------------------"));
        ValidationType vt = isValid();
        if(vt == ValidationType.VALID){
            log(1, Messages.CC("&aLicense valid!"));
            log(0, Messages.CC("&aThank you for purchasing the plugin"));
            log(0, Messages.CC("&7-------------------------------------------"));
            return true;
        }else{
            log(1, Messages.CC("&cInvalid License"));
            log(1, Messages.CC("&cPlease try again with a valid license"));
            log(0, Messages.CC("&7-------------------------------------------"));
